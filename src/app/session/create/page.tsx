...
export default function CreateSessionPage() {
  ...
  const languageOptions = [
    { value: 'javascript', label: 'JavaScript', color: 'text-yellow-500' },
    { value: 'typescript', label: 'TypeScript', color: 'text-blue-500' },
    { value: 'python', label: 'Python', color: 'text-green-500' },
    { value: 'html', label: 'HTML', color: 'text-orange-500' },
    { value: 'css', label: 'CSS', color: 'text-purple-500' },
    { value: 'cpp', label: 'C++', color: 'text-blue-600' },
    { value: 'java', label: 'Java', color: 'text-red-500' },
    { value: 'react', label: 'React JSX', color: 'text-cyan-500' },
  ]
        ...
        <div className="container mx-auto px-4 py-8 max-w-2xl">
          ...
          <div className="mt-6 p-4 rounded-lg bg-muted/50">
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              ...
              <li>• Public sessions are great for learning together</li>
              <li>• Private sessions are perfect for team projects</li>
            </ul>
          </div>
        </div>
      </div>
