    ...
    <ProtectedRoute>
      <div className="min-h-screen bg-gray-900">
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <div className="mb-8">
            <Link href="/dashboard">
              <Button 
                variant="ghost" 
                size="sm" 
                className="mb-6 hover:bg-gray-800 transition-colors"
              >
            ...
            <form onSubmit={handleSubmit}>
              <CardHeader className="pb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-white">Session Configuration</h2>
                    ...
                    <div className="grid gap-6">
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <span className={cn(
                            "text-xs font-medium",
                            formData.title.length > 80 ? "text-yellow-400" : "text-gray-400"
                          )}>
                            {formData.title.length}/100
                          </span>
                        </div>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <button
                            ...
                            disabled={loading}
                            className={cn(
                              "group p-6 border-2 rounded-lg text-left transition-colors hover:border-green-500",
                              formData.type === 'PUBLIC'
                          ...
                          >
                            ...
                            <h3 className="font-bold text-lg text-white mb-3">Public Session</h3>
                          ...
                          <button
                            ...
                            disabled={loading}
                            className={cn(
                              "group p-6 border-2 rounded-lg text-left transition-colors hover:border-blue-500",
                              formData.type === 'PRIVATE'
                          ...
                          >
                            ...
                            <h3 className="font-bold text-lg text-white mb-3">Private Session</h3>
                            <p className="text-sm text-gray-400 leading-relaxed mb-4">
                              Invite-only access with host approval. Ideal for team projects, client work, and focused collaboration.
                            </p>
                            ...
                            <div className="flex items-center justify-between p-4">
                              <div className="flex items-center space-x-4">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-gray-400">Automatically save changes every 30 seconds</p>
                                </div>
                              </div>
                              <Switch
                                checked={formData.autoSave}
                          ...
                          <Card>
                            <div className="flex items-center justify-between p-4">
                              <div className="flex items-center space-x-4">
                                ...
                                <div>
                                  <h4 className="font-semibold text-white">Chat System</h4>
                                  <p className="text-sm text-gray-400">Enable real-time chat for collaboration</p>
                                </div>
                              </div>
                              <Switch
                                checked={formData.allowChat}
                            ...
                            <div className="flex items-center justify-between p-4">
                              <div className="flex items-center space-x-4">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-gray-400">Allow participants to upload files</p>
                                </div>
                              </div>
                              <Switch
                                checked={formData.allowFileUpload}
          ...
          <Card className="mt-8 rounded-lg">
            <CardHeader>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white">Pro Tips for Successful Sessions</h3>
                  <p className="text-gray-400">Make the most of your collaborative coding experience</p>
                </div>
              </div>
            </CardHeader>
            <CardContent>
          ...
          {/* Footer */}
          <div className="flex justify-center py-8">
            <div className="inline-flex items-center space-x-2 text-xs text-gray-500 bg-gray-800 px-4 py-2 rounded-full border border-gray-700">
