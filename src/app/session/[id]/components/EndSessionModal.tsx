      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <div className="flex items-center space-x-3">
            ...
            <div>
              <DialogTitle className="text-lg font-semibold">End Session?</DialogTitle>
              <DialogDescription className="text-sm">
                This will immediately disconnect all participants and stop collaboration.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          {/* Warning */}
          <div className="flex items-start space-x-3 p-3 bg-destructive/5 border border-destructive/20 rounded-lg">
            <AlertTriangle className="h-4 w-4 text-destructive flex-shrink-0 mt-0.5" />
            <div className="text-sm">
              <p className="font-medium text-destructive mb-1">This action cannot be undone</p>
              <p className="text-muted-foreground">All participants will be disconnected immediately.</p>
            </div>
          </div>

          {/* Data safety */}
          <div className="flex items-start space-x-3 p-3 bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-900/30 rounded-lg">
            <Shield className="h-4 w-4 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5" />
            <div className="text-sm">
              <p className="font-medium text-green-800 dark:text-green-200 mb-1">Your data is safe</p>
              <p className="text-green-700 dark:text-green-300">All files and chat history will be preserved.</p>
            </div>
          </div>
          ...
          {endSessionLoading && (
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium">Ending session...</span>
                <span className="text-sm text-muted-foreground">{Math.round(confirmationProgress)}%</span>
              </div>
