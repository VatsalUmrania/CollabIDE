...
export default function SessionHeader({
  ...
  const getSyncIcon = () => {
    switch (syncStatus) {
      ...
      case 'syncing':
        return { icon: RefreshCw, color: 'text-blue-400', animate: true };
      case 'offline':
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center space-x-2">
                ...
                <div className={cn(
                  ...
                  session.isActive ? "bg-green-400" : "bg-gray-500"
                )} />
              ...
              <div className="flex items-center space-x-4 text-xs text-gray-400 mt-1">
                ...
                <div className="flex items-center space-x-1">
                  <syncIcon.icon className={cn(
                    "h-3 w-3", 
                    syncIcon.color,
                    syncIcon.animate && "animate-spin"
                  )} />
                  <span className="capitalize">{syncStatus}</span>
                </div>
              </div>
  ...
  // Desktop Layout - Clean & Professional
  return (
    <header className="bg-gray-900 border-b border-gray-800 px-6 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        {/* Left Section - Clean Layout */}
        <div className="flex items-center space-x-6 min-w-0 flex-1">
          {/* Logo */}
          <HeroLogo size="sm" variant="compact" />
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-2 text-sm">
                  ...
                  <span className={cn("capitalize", syncIcon.color)}>
                    {syncStatus}
                  </span>
                </div>
                ...
                {/* Host Badge */}
                {isHost && (
                  <div className="flex items-center space-x-1 px-2 py-1 bg-amber-900/30 text-amber-400 rounded-md text-sm">
        ...
        <div className="flex items-center space-x-2">
          ...
          {/* Primary Actions */}
          {isHost && (
            <div className="flex items-center space-x-2 ml-4 pl-4 border-l border-gray-800">
              <Button 
                size="sm"
                onClick={showInviteModal}
