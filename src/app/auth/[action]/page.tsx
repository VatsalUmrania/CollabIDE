...
export default function AuthPage() {
  ...
  console.log('Current route:', params.action)
      ...
      <div className="w-full max-w-md">
        <div className="bg-gray-900 rounded-xl p-8 shadow-xl">
          ...
          <div className="flex mb-6">
            <div className="flex bg-gray-800 rounded-lg p-1 w-full">
              <Link
                href="/auth/login"
                className={cn(
                  "flex-1 text-center py-2 px-4 text-sm font-medium rounded-md transition-all",
                  !isRegister 
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    id="name"
                    type="text"
                    className="pl-10 h-11 bg-gray-800 border-gray-700 text-white placeholder:text-gray-500 focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  id="password"
                  type={showPassword ? "text" : "password"}
                  className="pl-10 pr-10 h-11 bg-gray-800 border-gray-700 text-white placeholder:text-gray-500 focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                ...
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="absolute right-2 top-1/2 -translate-y-1/2 h-7 w-7 p-0 text-gray-500 hover:text-gray-300"
            ...
            {isRegister && (
              <div>
                <Label htmlFor="confirm-password" className="text-sm font-medium text-gray-300 block mb-2">
                  Confirm Password
                </Label>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-500" />
                  <Input
                    ...
                    type={showPassword ? "text" : "password"}
                    className={cn(
                      "pl-10 h-11 bg-gray-800 border-gray-700 text-white placeholder:text-gray-500 focus:border-blue-500 focus:ring-1 focus:ring-blue-500",
                      fields.confirmPassword && fields.password !== fields.confirmPassword && "border-red-500 focus:border-red-500"
                    )}
