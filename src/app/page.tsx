...
//               <img src="/logo.png" alt="CollabIDE Logo" className="w-full h-full object-contain" />
//             </div>
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col theme-gradient-bg text-foreground">
      {/* ===== Header ===== */}
      <header className="sticky top-0 z-40 theme-glass-card border-b border-border">
        <div className="max-w-7xl mx-auto flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
          <Link
            href="/"
            className="flex items-center space-x-2 theme-focusable rounded-lg px-2 py-1"
          >
            <div className="w-8 h-8 rounded-lg bg-primary flex items-center justify-center">
              <Code className="w-5 h-5 text-primary-foreground" />
            </div>
            <span className="text-2xl font-bold theme-gradient-primary">
              CollabIDE
            </span>
          </Link>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link
              href="#features"
              className="text-foreground-muted hover:text-foreground transition-colors theme-focusable"
            >
              Features
            </Link>
            <Link
          ...
          <div className="hidden md:flex items-center space-x-3">
            <Link href="/auth/login">
              <Button variant="outline" className="theme-btn theme-btn-outline">
                Sign In
              </Button>
            </Link>
            <Link href="/auth/register">
          ...
          {/* Mobile Menu Button */}
          <div className="md:hidden">
            <Button variant="ghost" size="icon" onClick={() => setIsMenuOpen(true)} className="theme-focusable">
              <Menu className="h-6 w-6" />
              <span className="sr-only">Open menu</span>
            </Button>
          </div>
      ...
      {/* Mobile Menu Overlay */}
      {isMenuOpen && (
        <div className="fixed inset-0 z-50 theme-gradient-bg backdrop-blur-sm md:hidden">
          <div className="flex flex-col items-center justify-center h-full">
            <Button 
              variant="ghost" 
              size="icon" 
              onClick={() => setIsMenuOpen(false)}
              className="absolute top-4 right-4 theme-focusable"
            >
              <X className="h-6 w-6" />
              <span className="sr-only">Close menu</span>
            </Button>
            ...
            <div className="mt-12 flex flex-col space-y-4 w-full px-8">
               <Link href="/auth/login" className="w-full">
                <Button variant="outline" className="w-full theme-btn theme-btn-outline text-lg" onClick={() => setIsMenuOpen(false)}>
                  Sign In
                </Button>
              </Link>
              <Link href="/auth/register" className="w-full">
                <Button className="w-full theme-btn theme-btn-primary text-lg" onClick={() => setIsMenuOpen(false)}>
                  Get Started
                  <ChevronRight className="w-4 h-4 ml-1" />
                </Button>
              </Link>
      ...
      <section className="relative isolate overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <div className="absolute top-0 left-1/4 w-96 h-96 rounded-full blur-3xl theme-animate-float"
               style={{ background: 'hsl(var(--primary) / 0.15)' }} />
          <div className="absolute top-1/3 right-1/4 w-80 h-80 rounded-full blur-3xl theme-animate-float" 
               style={{ background: 'hsl(var(--accent) / 0.12)', animationDelay: '2s' }} />
          <div className="absolute bottom-0 left-1/3 w-72 h-72 rounded-full blur-3xl theme-animate-float" 
               style={{ background: 'hsl(var(--secondary) / 0.1)', animationDelay: '4s' }} />
        </div>

        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center py-16 md:py-24 px-4 sm:px-6 lg:px-8">
          {/* Hero Content */}
          <div className="theme-animate-fade-in text-center lg:text-left">
            <div className="inline-flex items-center px-3 py-1 rounded-full text-sm mb-6 theme-glass-card"
                 style={{ 
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-6">
              Code together in <span className="theme-gradient-primary">real-time</span>
            </h1>
            
            <p className="text-lg sm:text-xl text-foreground-muted mb-10 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              CollabIDE empowers students and educators to build, learn, and ship 
              projects together — directly in the browser with zero setup required.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8 justify-center lg:justify-start">
              <Link href="/auth/register" className="w-full sm:w-auto">
                <Button size="lg" className="theme-btn theme-btn-primary theme-btn-lg text-lg px-8 w-full sm:w-auto">
                  <span className="flex items-center">
                    Start Coding Free
                    <ChevronRight className="w-5 h-5 ml-2" />
                  </span>
              ...
              <Button asChild variant="outline" size="lg" className="theme-btn theme-btn-outline theme-btn-lg text-lg px-8 w-full sm:w-auto">
                <a href="#demo">
                  <span className="flex items-center">
                    <PlayCircle className="h-5 w-5 mr-2" />
                    Watch Demo
            ...
            {/* Social Proof */}
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 sm:gap-6 text-sm text-foreground-muted">
              <div className="flex items-center gap-2">
                <div className="flex -space-x-2">
                  {[
                    { bg: 'linear-gradient(135deg, hsl(var(--primary)) 0%, hsl(var(--accent)) 100%)' },
                    { bg: 'linear-gradient(135deg, hsl(var(--secondary)) 0%, hsl(var(--primary)) 100%)' },
                    { bg: 'linear-gradient(135deg, hsl(var(--accent)) 0%, hsl(var(--secondary)) 100%)' }
                  ].map((user, i) => (
              ...
              <div className="flex items-center gap-1">
                <div className="theme-status-indicator theme-status-online" />
                <span>99.9% uptime</span>
              </div>
            </div>
          </div>
          ...
          {/* Hero Visual */}
          <div className="w-full aspect-[16/10] relative theme-animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <div className="theme-glass-card rounded-2xl overflow-hidden shadow-2xl">
              <div className="h-8 bg-surface-elevated border-b border-border flex items-center px-4 gap-2">
                <div className="flex gap-2">
                  <div className="w-3 h-3 rounded-full bg-destructive" />
                  <div className="w-3 h-3 rounded-full bg-warning" />
                  <div className="w-3 h-3 rounded-full bg-success" />
                </div>
                <span className="text-xs text-foreground-subtle ml-4 truncate">
                  CollabIDE - main.js
                </span>
              </div>
              
              <div className="bg-background-subtle p-4 font-mono text-xs sm:text-sm">
                <div className="space-y-2">
                  <div className="flex">
                    <span className="text-foreground-subtle w-8 text-right mr-4">1</span>
                    <span style={{ color: 'hsl(var(--accent))' }}>const</span>
                    <span className="text-foreground ml-2">message</span>
                    <span className="text-foreground-subtle ml-2">=</span>
                    <span className="ml-2" style={{ color: 'hsl(var(--success))' }}>&apos;Hello, World!&apos;</span>
                  </div>
                  <div className="flex">
                    <span className="text-foreground-subtle w-8 text-right mr-4">2</span>
                    <span style={{ color: 'hsl(var(--secondary))' }}>console</span>
                    <span className="text-foreground-subtle">.</span>
                    <span style={{ color: 'hsl(var(--primary))' }}>log</span>
                    <span className="text-foreground-subtle">(</span>
                    <span className="text-foreground">message</span>
                    <span className="text-foreground-subtle">)</span>
                  </div>
                  <div className="flex">
                    <span className="text-foreground-subtle w-8 text-right mr-4">3</span>
                    <div className="collab-cursor h-5 w-0.5" />
                  </div>
                </div>
              </div>
            </div>

            <div className="absolute -top-4 -right-4 theme-glass-card rounded-lg p-3 text-xs sm:text-sm theme-animate-fade-in" 
                 style={{ animationDelay: '1s' }}>
              <div className="flex items-center gap-2">
                <div className="theme-status-online theme-status-indicator" />
                <span>3 users online</span>
              </div>
            </div>
            
            <div className="absolute -bottom-4 -left-4 theme-glass-card rounded-lg p-3 text-xs sm:text-sm theme-animate-fade-in" 
      ...
      {/* ===== Feature Grid ===== */}
      <section id="features" className="py-20 md:py-24 bg-surface-elevated">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16 theme-animate-fade-in">
            <h2 className="text-3xl sm:text-4xl font-bold mb-6">
              Everything you need for <span className="theme-gradient-primary">collaborative coding</span>
            </h2>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { 
                ...
                desc: 'Experience instant propagation of every keystroke across all participants with sub-50ms latency.',
                color: 'linear-gradient(135deg, hsl(var(--accent)) 0%, hsl(var(--primary)) 100%)'
              },
              { 
                icon: Users, 
                title: 'Unlimited Collaboration', 
                desc: 'See live cursors, selections, and edits for everyone in your session, regardless of class size.',
                color: 'linear-gradient(135deg, hsl(var(--success)) 0%, hsl(142 85% 32%) 100%)'
              },
              { 
                icon: Code, 
                title: 'Smart Code Editor', 
                desc: 'Full syntax highlighting, intelligent autocomplete, and error detection for 15+ programming languages.',
                color: 'linear-gradient(135deg, hsl(var(--secondary)) 0%, hsl(267 85% 48%) 100%)'
              },
              { 
                icon: Shield, 
                title: 'Enterprise Security', 
                desc: 'Role-based access control with optional session passwords and OAuth integration for safe learning.',
                color: 'linear-gradient(135deg, hsl(var(--info)) 0%, hsl(210 100% 55%) 100%)'
              },
              { 
                icon: MessageSquare, 
                title: 'Integrated Communication', 
                desc: 'Built-in chat and commenting system to discuss code without losing context or switching apps.',
                color: 'linear-gradient(135deg, hsl(var(--destructive)) 0%, hsl(0 85% 48%) 100%)'
              },
              { 
                icon: Download, 
                title: 'One-Click Export', 
                desc: 'Bundle your entire collaborative project as a production-ready zip with documentation included.',
                color: 'linear-gradient(135deg, hsl(var(--warning)) 0%, hsl(45 100% 50%) 100%)'
              },
            ].map(({ icon: Icon, title, desc, color }, index) => (
              <Card key={title} className="theme-card group theme-animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
                <CardHeader className="text-center items-center pb-4">
                  <div className="mx-auto mb-4 p-4 rounded-2xl w-fit shadow-lg"
                ...
                <CardContent>
                  <CardDescription className="text-center text-foreground-muted leading-relaxed">
                    {desc}
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              <div className="relative max-w-4xl mx-auto">
                  <div className="theme-glass-card rounded-2xl overflow-hidden shadow-2xl">
                      <div className="aspect-video flex items-center justify-center"
                           style={{ 
                             background: 'linear-gradient(135deg, hsl(var(--primary) / 0.15) 0%, hsl(var(--accent) / 0.12) 100%)'
                           }}>
                          <Button size="lg" className="theme-btn theme-btn-primary theme-btn-lg">
                              <span className="flex items-center">
                                <PlayCircle className="w-6 h-6 mr-2" />
                                Play Demo Video
                              </span>
      ...
      <section className="py-20 md:py-24 relative overflow-hidden"
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 left-0 w-full h-full" 
               style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.1'%3E%3Ccircle cx='7' cy='7' r='1'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")` }} />
        </div>
        <div className="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-white">
            Ready to revolutionize your coding workflow?
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link href="/auth/register" className="w-full sm:w-auto">
              <Button size="lg" variant="secondary" className="theme-btn theme-btn-lg text-lg px-10 w-full sm:w-auto bg-white text-primary-foreground hover:bg-gray-100">
                <span className="flex items-center">
                  Create Free Account
                  <ChevronRight className="w-5 h-5 ml-2" />
                </span>
      ...
      {/* ===== Footer ===== */}
      <footer className="bg-surface border-t border-border pt-16 pb-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid gap-8 md:grid-cols-4 lg:grid-cols-5 mb-12">
            <div className="md:col-span-2 space-y-4">
              <div className="flex items-center space-x-2">
              ...
              <div className="flex space-x-4">
                {[
                  { icon: Twitter, href: '#', label: 'Twitter' },
                  { icon: Github, href: 'https://github.com/vatsalumrania/collabide', label: 'GitHub' },
                  { icon: Linkedin, href: '#', label: 'LinkedIn' },
                ].map(({ icon: Icon, href, label }) => (
                  <a key={label} href={href} 
                     className="w-10 h-10 rounded-lg bg-surface-hover hover:bg-primary hover:text-primary-foreground transition-all duration-200 flex items-center justify-center group theme-focusable" 
                     aria-label={label}>
                    <Icon className="w-5 h-5" />
                  </a>
                ))}
              ...
              {[
                ...
                <div key={col.heading}>
                  ...
                  <ul className="space-y-3">
                    {col.links.map(link => (
                      <li key={link.name}>
                        <a href={link.href} className="text-foreground-muted hover:text-foreground transition-colors theme-focusable">{link.name}</a>
                      </li>
                    ))}
                  </ul>
                </div>
          ...
          <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-foreground-muted text-sm text-center md:text-left">
              © {new Date().getFullYear()} CollabIDE. All rights reserved.
            </div>
