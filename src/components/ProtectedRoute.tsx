...
export function ProtectedRoute({ 
  ...
  if (loading || !authChecked) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-900">
        <div className="text-center bg-gray-800 rounded-lg border border-gray-700 p-8 max-w-md mx-4">
  ...
  if (authError && showError) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-900 p-4">
        <Card className="max-w-md w-full">
          <CardHeader className="text-center">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-red-900/30 rounded-lg mb-4 mx-auto">
  ...
  if (isRedirecting) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-900">
        <div className="text-center bg-gray-800 rounded-lg border border-gray-700 p-8 max-w-md mx-4">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-yellow-600 rounded-lg mb-6">
            <Lock className="h-8 w-8 text-white" />
          </div>
          <div className="flex items-center justify-center space-x-3 mb-4">
        ...
        <Card className="max-w-md w-full">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-lg p-4">
              <h4 className="font-medium text-white mb-2">Need access?</h4>
