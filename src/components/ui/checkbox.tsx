...
const checkboxVariants = cva(
  "peer shrink-0 border ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 transition-colors relative",
  {
    variants: {
      variant: {
        default: 
          "border-gray-600 hover:border-blue-500 data-[state=checked]:bg-blue-600 data-[state=checked]:text-white data-[state=checked]:border-blue-600 data-[state=indeterminate]:bg-blue-600 data-[state=indeterminate]:text-white data-[state=indeterminate]:border-blue-600",
        destructive:
          "border-red-600 hover:border-red-500 data-[state=checked]:bg-red-600 data-[state=checked]:text-white data-[state=checked]:border-red-600 data-[state=indeterminate]:bg-red-600 data-[state=indeterminate]:text-white data-[state=indeterminate]:border-red-600",
        success:
          "border-green-600 hover:border-green-500 data-[state=checked]:bg-green-600 data-[state=checked]:text-white data-[state=checked]:border-green-600 data-[state=indeterminate]:bg-green-600 data-[state=indeterminate]:text-white data-[state=indeterminate]:border-green-600",
        warning:
          "border-yellow-600 hover:border-yellow-500 data-[state=checked]:bg-yellow-600 data-[state=checked]:text-black data-[state=checked]:border-yellow-600 data-[state=indeterminate]:bg-yellow-600 data-[state=indeterminate]:text-black data-[state=indeterminate]:border-yellow-600",
        info:
          "border-blue-500 hover:border-blue-400 data-[state=checked]:bg-blue-500 data-[state=checked]:text-white data-[state=checked]:border-blue-500 data-[state=indeterminate]:bg-blue-500 data-[state=indeterminate]:text-white data-[state=indeterminate]:border-blue-500",
        outline:
          "border-gray-600 hover:border-blue-500 data-[state=checked]:border-blue-500 data-[state=checked]:bg-gray-900 data-[state=checked]:text-blue-500 hover:bg-gray-800",
        ghost:
          "border-transparent hover:bg-gray-800 hover:text-gray-200 data-[state=checked]:bg-blue-900/30 data-[state=checked]:text-blue-300 data-[state=checked]:border-blue-700",
      },
      size: {
        xs: "h-3 w-3 text-xs",
        sm: "h-3.5 w-3.5 text-sm",
      ...
      <div className="grid gap-1.5 leading-none flex-1 min-w-0">
        {label && (
          <label
            htmlFor={props.id}
            className={cn(
              "text-sm font-medium leading-relaxed cursor-pointer transition-colors",
              "peer-disabled:cursor-not-allowed peer-disabled:opacity-70",
        ...
        {description && (
          <p className={cn(
            ...
            error ? "text-red-400/80" : "text-gray-400",
...
>(({ collaborator, showStatus = true, ...props }, ref) => {
  const getStatusIcon = () => {
    switch (collaborator.status) {
      ...
      case 'offline': return <div className="w-2 h-2 rounded-full bg-gray-500" />
    }
  }
